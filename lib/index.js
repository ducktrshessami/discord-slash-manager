        ...
        return phin({
            ...
            .then(res => {
                if (res.statusCode === 201) {
                    ...
                    (data.guildID ? this.#resolveGuildCache(data.guildID) : this.globalCache)._set(command.id, command);
                    return command;
                }
            });
    }
        ...
        return phin({
            ...
            .then(res => {
                if (res.statusCode === 200) {
                    let command = new Command(this, res.body);
                    (guildID ? this.#resolveGuildCache(guildID) : this.globalCache)._set(command.id, command);
                    return command;
                }
            });
    }
            ...
            .then(res => {
                if (res.statusCode === 200) {
                    ...
                    res.body.forEach(command => {
                        cache._set(command.id, new Command(this, command));
                    });
                    return cache;
                }
            });
        ...
        return phin({
            ...
            .then(res => {
                if (res.statusCode === 204) {
                    (guildID ? this.#resolveGuildCache(guildID) : this.globalCache)._delete(id);
                }
            })
    }
